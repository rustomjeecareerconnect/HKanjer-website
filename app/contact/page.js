...
import { FaLinkedin, FaBook, FaGraduationCap, FaEnvelope, FaMapMarkerAlt, FaCheckCircle, FaExclamationCircle, FaSpinner, FaChartLine } from 'react-icons/fa';
              ...
              <div className="card-base bg-accent/5 dark:bg-accent/10 border-accent/20 p-8 md:p-10 h-full flex flex-col">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="p-3 bg-surface-light dark:bg-surface border border-accent/10 rounded-xl text-text-dark-muted dark:text-text-muted hover:text-[#0A66C2] hover:border-accent/30 transition-all shadow-sm hover:shadow-md">
                      <FaLinkedin size={22} />
                    </a>
                    <a href="#" className="p-3 bg-surface-light dark:bg-surface border border-accent/10 rounded-xl text-text-dark-muted dark:text-text-muted hover:text-accent hover:border-accent/30 transition-all shadow-sm hover:shadow-md" title="Google Scholar">
                      <FaGraduationCap size={22} />
                    </a>
                    <a href="#" className="p-3 bg-surface-light dark:bg-surface border border-accent/10 rounded-xl text-text-dark-muted dark:text-text-muted hover:text-[#00CCBB] hover:border-accent/30 transition-all shadow-sm hover:shadow-md" title="ResearchGate">
                      <FaBook size={22} />
                    </a>
                  </div>
                </div>
