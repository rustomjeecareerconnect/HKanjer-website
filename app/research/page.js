    ...
    <main className="min-h-screen pt-24 pb-16">
      ...
      <section className="container-custom mb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <ScrollAnimation>
            <a href="#" className="flex items-center gap-6 p-8 glass-card border-2 border-accent/30 hover:border-accent rounded-xl transition-all duration-300 hover:-translate-y-1 group">
              ...
              <div>
                <h3 className="text-xl font-heading text-text-dark dark:text-text mb-1">Google Scholar</h3>
                <p className="text-text-dark-muted dark:text-text-muted">View Full Citation Index</p>
              </div>
            </a>
          </ScrollAnimation>
          <ScrollAnimation delay={0.1}>
            <a href="#" className="flex items-center gap-6 p-8 glass-card border-2 border-accent/30 hover:border-accent rounded-xl transition-all duration-300 hover:-translate-y-1 group">
              ...
              <div>
                <h3 className="text-xl font-heading text-text-dark dark:text-text mb-1">ResearchGate</h3>
                <p className="text-text-dark-muted dark:text-text-muted">Access Research Papers</p>
              </div>
            </a>
          </ScrollAnimation>
        </div>
